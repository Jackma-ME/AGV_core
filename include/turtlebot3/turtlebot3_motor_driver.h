...
class Turtlebot3MotorDriver
{
 public:
  ...
  bool writeVelocity(int64_t left_value, int64_t right_value, int64_t back_left_value, int64_t back_right_value);
  bool controlMotor(const float wheel_separation, const float wheel_separation2, float* value);
