...
#define WHEEL_SEPARATION                 0.125           // meter (BURGER : 0.160, WAFFLE : 0.287)
#define WHEEL_SEPARATION2                0.2            // meter
...
// Command velocity of Tu  IRsensor();rtlebot3 using RC100 remote controller
...
// Motor Reading
geometry_msgs::Twist motor_read_msg;
ros::Publisher motor_read_pub("motor_read", &motor_read_msg);

// IR sensor (distance between AGVs)
geometry_msgs::Twist IRsensor_msg;
ros::Publisher IRsensor_pub("agv_dist", &IRsensor_msg);
...
int32_t last_diff_tick2[WHEEL_NUM] = {0.0, 0.0};
double  last_rad[WHEEL_NUM]       = {0.0, 0.0};
double  last_rad2[WHEEL_NUM]       = {0.0, 0.0};

/*******************************************************************************
* Update Joint State
*******************************************************************************/
double  last_velocity[WHEEL_NUM]  = {0.0, 0.0};
double  last_velocity2[WHEEL_NUM]  = {0.0, 0.0};
...
float goal_velocity[VELOCITY_UNIT] = {0.0, 0.0, 0.0};
float goal_velocity_from_button[VELOCITY_UNIT] = {0.0, 0.0, 0.0};
float goal_velocity_from_cmd[VELOCITY_UNIT] = {0.0, 0.0, 0.0};
float goal_velocity_from_rc100[VELOCITY_UNIT] = {0.0, 0.0, 0.0};
...
/*******************************************************************************
* Declaration for Motor Information
*******************************************************************************/
dxl_ret_t left_current;
dxl_ret_t right_current;
dxl_ret_t back_left_current;
dxl_ret_t back_right_current;
uint32_t motor_current[CURRENT_NUM];
